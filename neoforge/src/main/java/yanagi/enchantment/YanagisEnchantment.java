...
public class YanagisEnchantment {
    ...
    // Creates a new BlockItem with the id "yanagisenchantment:example_block", combining the namespace and path
    public static final DeferredItem<BlockItem> EXAMPLE_BLOCK_ITEM = ITEMS.registerSimpleBlockItem("example_block", EXAMPLE_BLOCK);

    // Creates a new food item with the id "yanagisenchantment:example_id", nutrition 1 and saturation 2
    public static final DeferredItem<Item> EXAMPLE_ITEM = ITEMS.registerSimpleItem("example_item", new Item.Properties().food(new FoodProperties.Builder()
            .alwaysEdible().nutrition(1).saturationModifier(2f).build()));

    // Creates a creative tab with the id "yanagisenchantment:example_tab" for the example item, that is placed after the combat tab
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.yanagisenchantment")) //The language key for the title of your CreativeModeTab
    ...
    public YanagisEnchantment(IEventBus modEventBus, ModContainer modContainer) {
        ...
        YEEventHandler eventHandler = new YEEventHandler();
